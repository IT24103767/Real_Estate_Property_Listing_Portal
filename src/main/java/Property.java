...
public class Property {
    ...
    public Property(String location, double landSize, double price, String description, String ownerName, String ownerContact, boolean isAvailable, String imagePath, String userId, String buyerId) {
        this.location = location;
        this.landSize = landSize;
        this.price = price;
        this.description = description;
